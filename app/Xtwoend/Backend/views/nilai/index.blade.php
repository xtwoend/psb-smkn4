		...
		<div class="col-md-12">
			<div class="box">
                ...
                <div class="box-body table-responsive">
					...
					{{ Datatable::table()
					    ->addColumn('#ID', 'Nomor Daftar' ,'Nomor Ujian', 'Nama', 'Tanggal Lahir','Nilai UN', 'Nilai Test', 'Total Nilai','Pilihan 1', 'Pilihan 2')       // these are the column headings to be shown
